...
def tseries_to_dataframe(esm,mask=None,annual=False):
   #mask None _trop _trop_congo _land
    var='wbgt_daymean'
    if mask==None:
        mask=''
    ...
    data_dict = {
        'T_futCTL-presCTL': ds_TREFHTmean_ctl_mean.values-ds_TREFHTmean_hist_mean.values,
        'T_SUST-futCTL': ds_TREFHTmean_sust_mean.values-ds_TREFHTmean_ctl_mean.values,
        'T_INEQ-futCTL': ds_TREFHTmean_ineq_mean.values-ds_TREFHTmean_ctl_mean.values,
        'T_SUST-INEQ': ds_TREFHTmean_sust_mean.values-ds_TREFHTmean_ineq_mean.values,
        'WBGT_futCTL-presCTL': ds_wbgtmean_ctl_mean.values-ds_wbgtmean_hist_mean.values,
        'WBGT_SUST-INEQ': ds_wbgtmean_sust_mean.values-ds_wbgtmean_ineq_mean.values,
        'WBGT_SUST-futCTL': ds_wbgtmean_sust_mean.values-ds_wbgtmean_ctl_mean.values,
        'WBGT_INEQ-futCTL': ds_wbgtmean_ineq_mean.values-ds_wbgtmean_ctl_mean.values,
    }
    data_dict2 = {
        'T90_futCTL-presCTL': ds_TREFHTmax_ctl_mean.values-ds_TREFHTmax_hist_mean.values,
        'T90_SUST-futCTL': ds_TREFHTmax_sust_mean.values-ds_TREFHTmax_ctl_mean.values,
        'T90_INEQ-futCTL': ds_TREFHTmax_ineq_mean.values-ds_TREFHTmax_ctl_mean.values,
        'T90_SUST-INEQ': ds_TREFHTmax_sust_mean.values-ds_TREFHTmax_ineq_mean.values,
        'WBGT90_futCTL-presCTL': ds_wbgtmax_ctl_mean.values-ds_wbgtmax_hist_mean.values,
        'WBGT90_SUST-INEQ': ds_wbgtmax_sust_mean.values-ds_wbgtmax_ineq_mean.values,
        'WBGT90_SUST-futctl': ds_wbgtmax_sust_mean.values-ds_wbgtmax_ctl_mean.values,
        'WBGT90_INEQ-futCTL': ds_wbgtmax_ineq_mean.values-ds_wbgtmax_ctl_mean.values,
    }
    if annual:
        data_dict = {
        'T_futCTL-presCTL': ds_TREFHTmean_ctl_mean.groupby('time.year').mean(dim='time').values-ds_TREFHTmean_hist_mean.groupby('time.year').mean(dim='time').values,
        'T_SUST-futCTL': ds_TREFHTmean_sust_mean.groupby('time.year').mean(dim='time').values-ds_TREFHTmean_ctl_mean.groupby('time.year').mean(dim='time').values,
        'T_INEQ-futCTL': ds_TREFHTmean_ineq_mean.groupby('time.year').mean(dim='time').values-ds_TREFHTmean_ctl_mean.groupby('time.year').mean(dim='time').values,
        'T_SUST-INEQ': ds_TREFHTmean_sust_mean.groupby('time.year').mean(dim='time').values-ds_TREFHTmean_ineq_mean.groupby('time.year').mean(dim='time').values,
        'WBGT_futCTL-presCTL': ds_wbgtmean_ctl_mean.groupby('time.year').mean(dim='time').values-ds_wbgtmean_hist_mean.groupby('time.year').mean(dim='time').values,
        'WBGT_SUST-INEQ': ds_wbgtmean_sust_mean.groupby('time.year').mean(dim='time').values-ds_wbgtmean_ineq_mean.groupby('time.year').mean(dim='time').values,
        'WBGT_SUST-futCTL': ds_wbgtmean_sust_mean.groupby('time.year').mean(dim='time').values-ds_wbgtmean_ctl_mean.groupby('time.year').mean(dim='time').values,
        'WBGT_INEQ-futCTL': ds_wbgtmean_ineq_mean.groupby('time.year').mean(dim='time').values-ds_wbgtmean_ctl_mean.groupby('time.year').mean(dim='time').values,
    }
    data_dict2 = {
        'T90_futCTL-presCTL': ds_TREFHTmax_ctl_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_TREFHTmax_hist_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'T90_SUST-futCTL': ds_TREFHTmax_sust_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_TREFHTmax_ctl_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'T90_INEQ-futCTL': ds_TREFHTmax_ineq_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_TREFHTmax_ctl_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'T90_SUST-INEQ': ds_TREFHTmax_sust_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_TREFHTmax_ineq_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'WBGT90_futCTL-presCTL': ds_wbgtmax_ctl_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_wbgtmax_hist_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'WBGT90_SUST-INEQ': ds_wbgtmax_sust_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_wbgtmax_ineq_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'WBGT90_SUST-futCTL': ds_wbgtmax_sust_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_wbgtmax_ctl_mean.groupby('time.year').quantile(0.9, dim='time').values,
        'WBGT90_INEQ-futCTL': ds_wbgtmax_ineq_mean.groupby('time.year').quantile(0.9, dim='time').values-ds_wbgtmax_ctl_mean.groupby('time.year').quantile(0.9, dim='time').values,
    }
    ...
    data_dict = {
        'T_presCTL': ds_TREFHTmean_hist_mean,
        'T_futCTL': ds_TREFHTmean_ctl_mean,
        'T_INEQ': ds_TREFHTmean_ineq_mean,
        'T_SUST': ds_TREFHTmean_sust_mean,
        'WBGT_presCTL': ds_wbgtmean_hist_mean,
        'WBGT_futCTL': ds_wbgtmean_ctl_mean,
        'WBGT_INEQ': ds_wbgtmean_ineq_mean,
        'WBGT_SUST': ds_wbgtmean_sust_mean
    }

    data_dict2 = {
        'T_presCTL': ds_TREFHTmax_hist_mean,
        'T_futCTL': ds_TREFHTmax_ctl_mean,
        'T_INEQ': ds_TREFHTmax_ineq_mean,
        'T_SUST': ds_TREFHTmax_sust_mean,
        'WBGT_presCTL': ds_wbgtmax_hist_mean,
        'WBGT_futCTL': ds_wbgtmax_ctl_mean,
        'WBGT_INEQ': ds_wbgtmax_ineq_mean,
        'WBGT_SUST': ds_wbgtmax_sust_mean
    }
    if annual:
        data_dict = {
        'T_presCTL': ds_TREFHTmean_hist_mean.groupby('time.year').mean(dim='time'),
        'T_futCTL': ds_TREFHTmean_ctl_mean.groupby('time.year').mean(dim='time'),
        'T_INEQ': ds_TREFHTmean_ineq_mean.groupby('time.year').mean(dim='time'),
        'T_SUST': ds_TREFHTmean_sust_mean.groupby('time.year').mean(dim='time'),
        'WBGT_presCTL': ds_wbgtmean_hist_mean.groupby('time.year').mean(dim='time'),
        'WBGT_futCTL': ds_wbgtmean_ctl_mean.groupby('time.year').mean(dim='time'),
        'WBGT_INEQ': ds_wbgtmean_ineq_mean.groupby('time.year').mean(dim='time'),
        'WBGT_SUST': ds_wbgtmean_sust_mean.groupby('time.year').mean(dim='time')
    }

    data_dict2 = {
        'T_presCTL': ds_TREFHTmax_hist_mean.groupby('time.year').max(dim='time'),
        'T_futCTL': ds_TREFHTmax_ctl_mean.groupby('time.year').max(dim='time'),
        'T_INEQ': ds_TREFHTmax_ineq_mean.groupby('time.year').max(dim='time'),
        'T_SUST': ds_TREFHTmax_sust_mean.groupby('time.year').max(dim='time'),
        'WBGT_presCTL': ds_wbgtmax_hist_mean.groupby('time.year').max(dim='time'),
        'WBGT_futCTL': ds_wbgtmax_ctl_mean.groupby('time.year').max(dim='time'),
        'WBGT_INEQ': ds_wbgtmax_ineq_mean.groupby('time.year').max(dim='time'),
        'WBGT_SUST': ds_wbgtmax_sust_mean.groupby('time.year').max(dim='time')
    }
 ...
 # Initialize an empty list to store data
    ...
    # Create a DataFrame from the data list
    df3 = pd.DataFrame(data, columns=[ 'Variable','Category', 'Value'])
     # Initialize an empty list to store data
    data = []
    ...
    # Create a DataFrame from the data list
    df4 = pd.DataFrame(data, columns=[ 'Variable','Category', 'Value'])
